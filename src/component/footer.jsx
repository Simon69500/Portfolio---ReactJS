...
export default function Footer() {
  return (
    <div
      className="contenairFooter bg-dark text-white p-5
    ...
    >
      ...
      <section
        className="cardContact p-md-0
                  d-flex flex-column align-items-start                                  
        "
      >
        <h3 className="contactTitle fs-5 fw-normal m-0 pb-2 px-md-0">
          Jonh Doe
        </h3>
       ...
       {/* Footer - Partie Liens Utilises */}
      <section
        className="cardLink pt-4 p-md-0
                 d-flex flex-column align-items-start align-self-start
     
        "
      >
        <h3 className="linkTitle fs-5 fw-normal m-0 pb-2 px-md-0">
          Liens utiles
        </h3>
        <Link
          className="footerText text-white text-decoration-none fs-6 fw-normal m-0"
          to="/"
        ...
        {/* Footer - Partie Mes Dernières Réalisations */}
      <section
        className="cardPortfolio pt-4 p-md-0
                 d-flex flex-column align-items-start align-self-start

        "
      >
        <h3 className="portfolioTitle fs-5 fw-normal m-0 pb-2 px-md-0">

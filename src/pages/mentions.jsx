import "../sass/pages/mentions.scss";
      ...
      <main className="bg-light mb-5 pb-5">
        ...
        <div className="accordion mx-auto m-2 mb-5" id="accordionExample">
            ...
            >
              <div class="accordion-body">
                <section className="d-flex flex-column align-items-start">
                  <h3 className="contactTitle fs-5 fw-bold m-0 pb-2 px-md-0">
                    Jonh Doe
                  </h3>
                  ...
                  <div className="d-flex flex-row align-items-center">
                    ...
                    <p className="fs-6 fw-normal m-0 px-1">
                      john.doe@gmail.com
                    </p>
                  </div>
                </section>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body d-flex flex-column align-items-start">
                <h3 className="cardTitle fw-bolder">alwaysdata</h3>
                ...
                <div>
                  ...
                  <a className="px-2" href="https://www.alwaysdata.com/">
                    www.alwaysdata.com
                  </a>
                </div>
              </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body d-flex flex-column align-items-start">
                <h3 className="cardTitle fw-bolder">Crédits</h3>

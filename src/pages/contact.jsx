  ...
  return (
    <div>
      ...
      <main className="bg-light border-0 d-flex flex-column  justify-content-between m-0 pb-5 p-1">
        ...
        <div className="card border-0 w-75 p-0 m-0 p-md-2 flex-md-row justify-content-md-center mx-auto">
          <section className="d-flex flex-column align-items-start col-md-6 px-md-2">
            <h2 className="card-title border-bottom border-primary border-3 w-100 pb-3 mt-3 text-start fw-bold">
              Formulaire de contact
            </h2>


            {/* Formulaire de la page Contact */}
            <form className="needs-validation d-flex flex-column align-items-start w-100 p-3 mt-4">
            ...
            {/*  page Contact - Mes cordonnées */}
          <section className="col-md-6 px-md-2">
            <h2 className="card-title border-bottom border-primary border-3 w-100 pb-3 mt-3 text-start fw-bold">
              Mes cordonnées
            </h2>
            <div className="d-flex flex-column align-items-start">
              <h3 className="contactTitle fs-5 fw-bold m-0 mt-5 pb-2 px-md-0">
                Jonh Doe
              </h3>
              ...
              <div className="d-flex flex-row align-items-center">
                ...
                <address className="fs-6 fw-normal m-0 px-1">

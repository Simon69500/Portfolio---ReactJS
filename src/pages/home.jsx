...
return(
    ...
    <main className="h-100 w-100 bg-light">
        ...
        >
            <section className="articleSection d-flex flex-column align-items-start 
            ...
            ">
                ...
                <img src="/img/john-doe-about.jpg" className="card-img-top pt-4 img-fluid " alt="un homme pensif sur son bureau de travail"/>
                <p className="text-start mt-3">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo odio eveniet, 
                    temporibus quisquam magni dolorum accusantium nostrum consectetur dignissimos.
                </p>
